...
let UsersService = class UsersService {
    ...
    async getLoggedInUser(req) {
        ...
        console.log(...oo_oo(`1713489095_152_4_152_52_4`, { user, refreshToken, accessToken }));
