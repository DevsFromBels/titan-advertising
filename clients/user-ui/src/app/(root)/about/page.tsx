...
const Page = () => {
  return (
    <div>
      ...
      <div className={'flex flex-col max-w-[1000px]] mt-3 gap-5'}>
        <p><b>Our company</b> revolutionizes personal and organizational budgeting by transforming intricate spreadsheets into intuitive, mobile-friendly financial management tools.</p>
